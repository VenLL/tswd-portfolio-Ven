| [visualizing debt](visualizing-government-debt.md) | [critique by design](critique-by-design.md) | [final project I](final-project-part-one.md) | [final project II](final-project-part-two.md) | [final project III](final-project-part-three.md) |
...
7. **_Engagement_** was rated a 7. In order to get a more rounded understanding of the data, viewers would have to interact with the graphs. However, the engagement was out of necessity and not voluntarily. The way the viz was designed may also refrain its viewers from further sharing or engaging with the data viz, with a fear of the viz being too difficult or effort-consuming for oneself or others to interpret.

### What Works?
* The overall color scheme—the blues are easy on the eyes.
* The “New York Times” newspaper style stood out to me. 
* The interactiveness and data inclusion regarding the “map” sheet of the Tableau viz was great—thus the map section will not be my area of focus when making redesigns.
...
* The tree map filled with different data and metrics—-it is not only difficult to understand but can also cause misinterpretations, as the size of the blocks are counterintuitive when it comes to percentages.
* Text hierarchy.
* The inclusion of instructions or subtexts when showcasing more complex charts.

### What I May Try To Adjust & What I Gleaned From The Critique Method:

* Break the emphasis of total layoff numbers verses the percentages into two different graphs—as the respective data tells different stories, and as it may cause misunderstanding when graphed altogether via a tree map. It may also be interesting to compare the differences as two separate graphs. 
...
* Declutter the tree map by perhaps choosing another type of graph depiction, and by focusing on the the top 10 rows or variables instead of squeezing 400 variables into one graph.
...
Asides from my redesigned drafts, I had shown the participants the original data viz for comparison. This lead to great feedback that I am thankful for.
...
* “Maybe something more can be added to the second drafted graph? It is quite plain at the moment. Not to say that it being plain is bad, as it is clear. But maybe more information or color can be added to make the graph more dynamic or engaging. ”
